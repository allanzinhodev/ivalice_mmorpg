...
monster.loot = {
	-- Summer 2026 loot omitted until the loose prayer beads client item exists.
...
-- Melee is UNSOURCED, scaled against Radiant Zealot (36500 HP) - verify in game.
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = -1600, maxDamage = -2050 },
